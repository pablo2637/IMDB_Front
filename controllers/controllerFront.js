...
const loginUser = async (req, res) => {
    ...
    if (req.user.rol == 'admin') res.send('dashboard-admin');
    else res.send('dashboard-user');
}

const userDashboard = async (req, res) => {
    res.render('dashboard-user', { user: req.oidc.user })
}

const adminDashboard = async (req, res) => {
    res.render('dashboard-admin', { user: req.oidc.user })
}
